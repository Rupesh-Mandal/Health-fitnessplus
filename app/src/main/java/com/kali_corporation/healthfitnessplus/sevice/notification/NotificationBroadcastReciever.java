package com.kali_corporation.healthfitnessplus.sevice.notification;
...
public class NotificationBroadcastReciever extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName componentName = ((RunningTaskInfo) ((ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE)).getRunningTasks(1).get(0)).topActivity;
